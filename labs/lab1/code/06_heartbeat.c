...
int main(void){
    ...
    for(;;){
        ...
        pulsing_variable_intensity(0.1, 0, 100);
        pulsing_variable_intensity(0.4, 100, 0);
        pulsing_variable_intensity(0.1, 0, 50);
        pulsing_variable_intensity(0.4, 50, 0);
        pulsing_variable_intensity(2, 0, 0);
        pulsing_variable_intensity(0.1, 0, 100);
        pulsing_variable_intensity(0.4, 100, 0);
        pulsing_variable_intensity(0.1, 0, 50);
        pulsing_variable_intensity(0.4, 50, 0);
        _delay_ms(2000); // add for some delay between heartbeats
    }
